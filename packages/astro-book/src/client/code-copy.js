export function initializeCodeCopy(root = document) {
  ...
  root.querySelectorAll("main .highlight").forEach(function (block) {
    if (block.closest('[data-book-island], [data-demo]')) return;
  ...
  root.querySelectorAll("main pre.mermaid").forEach(function (pre) {
    if (pre.closest('[data-book-island], [data-demo]') || pre.parentElement?.dataset.codeCopyEnhanced === 'true') return;
  ...
  root.querySelectorAll("main pre > code").forEach(function (code) {
    if (code.closest('[data-book-island], [data-demo]') || code.parentElement?.parentElement?.dataset.codeCopyEnhanced === 'true') return;
